...
namespace GraphicLib.OpenGL
{
  ...
  public static class Matrix
  {
    ...
    public static void Matrix4Ortho(IList<float> projectionMatrix, float left, float right, float bottom, float top,
